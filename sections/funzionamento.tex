...
\begin{figure}[h!]  %DA RISCALARE COMPLETAMENTE
    \centering
    \includegraphics[width=1\textwidth]{ConsoleDownLink.png}
...
%Immagine console con ricezione messaggi??
...
è acceso significa che il sistema è nello stato di selezione del numero di dati, se spento lo stato sarà quello del lancio dei dadi. %DA VERIFICARE
