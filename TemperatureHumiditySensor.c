...
/* USER CODE BEGIN PV */
static HTS221_Object_t HTS221_OB_Handle;  //Variabili per inizializzare i driver del sensore
...
int main(void)
{
  ...
  HTS221_USER_Init(); //Inizializzazione
...
void HTS221_USER_Init(void)
{
	...
	HTS221_IO_Handle.Address = 0xBE;  //Indirizzo I4c
	...
	HTS221_TEMP_GetOutputDataRate(&HTS221_OB_Handle, &dr); //dr= data rate
	printf("> .. Temp DR: %f", dr);
}
